...
namespace inference_search {
    ...
    void InferenceSearch::initialize() {
        log << "Conducting lazy inference best first search, (real) bound = " << bound << endl;
    ...
    vector<OperatorID> InferenceSearch::get_successor_operators(
    ...
    void InferenceSearch::generate_successors() {
    ...
    SearchStatus InferenceSearch::fetch_next_state() {
        if (open_list->empty()) {
        ...
        /*
          ...
          associate with the expanded vs. evaluated nodes in inference lazy search
    ...
    SearchStatus InferenceSearch::step() {
        // Invariants:
    ...
    void InferenceSearch::reward_progress() {
        open_list->boost_preferred();
    }

    void InferenceSearch::print_statistics() const {
